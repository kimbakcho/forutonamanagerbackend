...
public class MaliciousFalseReportService implements MaliciousJudgementService{
    ...
    public MaliciousFalseReportService(Integer idx, MaliciousBallDataRepository maliciousBallDataRepository, MUserInfoDataRepository mUserInfoDataRepository, CustomOAuth2User customOAuth2User) {
        this.idx = idx;
    ...
    public MaliciousBallResDto judgement() {
        ...
        maliciousBall.setFalseReportFlag(1);
