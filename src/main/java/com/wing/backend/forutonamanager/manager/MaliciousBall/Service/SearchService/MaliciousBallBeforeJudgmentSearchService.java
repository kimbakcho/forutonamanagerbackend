...
@Service
@Transactional
public class MaliciousBallBeforeJudgmentSearchService extends MaliciousBallSearchService{

    final MaliciousBallDataRepository maliciousBallDataRepository;

    public MaliciousBallBeforeJudgmentSearchService(MaliciousBallDataRepository maliciousBallDataRepository,FBallService fBallService) {
        super(fBallService);
    ...
    public Page<MaliciousBallResDto> search(Pageable pageable) {
        Page<MaliciousBall> byJudgmentUidNull = maliciousBallDataRepository.findByJudgmentUidNull(pageable);
        return makePageMaliciousBallResDto(byJudgmentUidNull);
    }
