package com.wing.backend.forutonamanager.Google;
...
@Component
public class GoogleStorageAdmin {

    private String storgeserviekeypath;

    Storage storage;

    GoogleStorageAdmin(@Value("${forutona.storgeserviekeypath}") String storgeserviekeypath) {
